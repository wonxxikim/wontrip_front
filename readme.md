...
<img src="docs/검색화면.png" width="800">

✔ **회원 정보 페이지**

- 로그인 & 회원가입 폼 구현
  <img src="docs/회원가입폼.png" width ="800">
  <img src="docs/로그인폼.png" width ="800">

- 마이페이지 (회원 정보 조회, 수정, 삭제)
  <img src = "docs/마이페이지.png" width = "800">
  <img src = "docs/회원정보수정.png" width = "800">
  <img src = "docs/회원정보삭제.png" width = "800">

✔ **지역별 관광지 조회 페이지**
<img src = "docs/검색페이지1.png" width = "800">

- 검색 랭킹 TOP 8의 관광지의 정보를 표시하고 상세정보는 "more" 버튼 클릭시 웹사이트로 이동
  <img src = "docs/top8.png" width = "800">

- 지역별 컨텐츠별 관광지 정보 조회
  <img src = "docs/map페이지.png" width = "800">

- 조회한 컨텐츠의 위치 정보를 지도에 표시
  <img src = "docs/map1.png" width = "800">
- 지도의 마커를 클릭하여 해당 위치의 상세 정보를 확인하고, 버튼을 통해 내 여행계획에 추가
  <img src = "docs/map2.png" width = "800">

✔ **여행 계획 게시판 페이지**

- 회원들이 올린 여행 계획 표시 & "more" 버튼 클릭시 자세한 계획내용으로 이동
  <img src = "docs/board.png" width = "800">
